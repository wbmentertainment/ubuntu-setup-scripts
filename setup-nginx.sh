#!/bin/bash
# Script setup systemd service media-nginx

PROJECT_DIR="/home/wbm/projects/media-nginx"
...
[Unit]
Description=Media Nginx Service
...
sudo systemctl enable media-nginx.service
